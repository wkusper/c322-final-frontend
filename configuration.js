...
const host_remote = "https://final-latest-baay.onrender.com";
...
async function updateTheNavigationBar() {
    ...
    let basket = document.getElementById("basket-link");
    let loginTag = navigation.children[navigation.children.length - 1];
    if (configuration.isLoggedIn()) {
        loginTag.innerHTML = 
        `<li class="right"> <a href="#" onclick="logout()">Logout </a> </li>`;
        basket.href = "delivery_information.html"
    } else {
        loginTag.innerHTML = 
        `<li class="right"> <a href="login.html">Login</a></li>`;
        basket.href = "delivery_information_guest.html"
    }
}
